...
//		about: './src/js/page/about.js',
	...
	output: { 
		path: path.join(__dirname, 'mobile'), //输出目录的配置，模板、样式、脚本、图片等资源的路径配置都相对于它
		publicPath: '/mobile/',				//模板、样式、脚本、图片等资源对应的server上的路径
...
//			chunks: ['index','list','about'], //提取哪些模块共有的部分
		...
		new HtmlWebpackPlugin({ //根据模板插入css/js等生成最终HTML
			favicon: './src/img/cib.jpg', //favicon路径，通过webpack引入同时可以生成hash值
